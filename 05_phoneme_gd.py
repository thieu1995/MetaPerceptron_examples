#!/usr/bin/env python
# Created by "Thieu" at 08:51, 24/12/2024 ----------%                                                                               
...
from metaperceptron import DataTransformer, MlpClassifier, Data
...
def run_trial(model, seed, data, metrics):
    ...
    if model["optim"] != "SGD":
        net = MlpClassifier(
            hidden_layers=(10,), act_names="Tanh", dropout_rates=None, act_output=None,
            epochs=model["epoch"], batch_size=32, optim=model["optim"], optim_paras=None,

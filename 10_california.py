...
from metaperceptron import DataTransformer, MhaMlpRegressor
...
def run_trial(model, seed, data):
    ...
    # Initialize model
    net = MhaMlpRegressor(
        hidden_layers=(5,), act_names="Tanh", dropout_rates=None, act_output=None,
        optim=model["class"], optim_paras=model["paras"], obj_name="MSE", seed=seed, verbose=False
    )

#!/usr/bin/env python
# Created by "Thieu" at 00:08, 27/12/2024 ----------%                                                                               
...
from data_util import get_sepsis_survival
...
def run_trial(model, seed, data, metrics):
    ...
    if model["optim"] != "SGD":
        net = MlpClassifier(
            ...
            epochs=model["epoch"], batch_size=1024, optim=model["optim"], optim_paras=None,
...
if __name__ == "__main__":
    ## Load data object
    X_train, X_test, y_train, y_test = get_sepsis_survival()
